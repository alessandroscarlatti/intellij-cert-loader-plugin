...
import com.scarlatti.certloader.services.dyorgio.process.OutProcessExecutorService;
import com.scarlatti.certloader.services.dyorgio.process.OutProcessUtils;
...
public class RemoteMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        javax.swing.JOptionPane.showMessageDialog(null, "RemoteMain");
        ...
        try (Socket socket = new Socket("localhost", Integer.valueOf(args[0]))) {
            ...
            while (socket.isConnected() && !socket.isClosed() && !socket.isInputShutdown()) {
                OutProcessUtils.readCommandExecuteAndRespond(socket.getInputStream(), objOut);
            }
        }
    }
}

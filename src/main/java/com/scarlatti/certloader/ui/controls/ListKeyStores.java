...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        jPanel.setMinimumSize(new Dimension(316, 129));
        jPanel.setPreferredSize(new Dimension(1280, 493));
        final JPanel panel1 = new JPanel();
        panel1.setLayout(new GridLayoutManager(2, 1, new Insets(0, 0, 0, 0), -1, -1));
        jPanel.add(panel1, new GridConstraints(0, 1, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        editToolbar = new JPanel();
        editToolbar.setLayout(new GridBagLayout());
        editToolbar.setAutoscrolls(false);
        editToolbar.setEnabled(true);
        panel1.add(editToolbar, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        editToolbar.add(removeButton, gbc);
        ...
        gbc.gridy = 2;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        editToolbar.add(editButton, gbc);
        ...
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        editToolbar.add(addButton, gbc);
        testInstallButton = new JButton();
        testInstallButton.setText("Test Install");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 3;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        editToolbar.add(testInstallButton, gbc);
        ...
        selectNoneButton.setText("Use None");
        panel2.add(selectNoneButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        selectAllButton = new JButton();
        selectAllButton.setText("Use All");
        ...
        jPanel.add(restoreDefaultsButton, new GridConstraints(1, 1, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
